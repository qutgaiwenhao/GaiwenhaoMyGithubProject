...
//        InputStream in = JavaMail.class.getResourceAsStream("a.properties");
//        try {
//            properties.load(in);
...
//        }
     ...
     *            收件人地址
     */
    public void doSendHtmlEmail(String subject, String sendHtml,String receiveUser,String host,String username,String password,String customerId) {
        try {
            // 发件人
...
//        se.doSendHtmlEmail("邮件主题", "邮件内容", "13585091527@139.com");
    }
}