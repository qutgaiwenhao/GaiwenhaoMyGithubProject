...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="星级标记" style="width:40px;">
				<img src="${ctx}/resource/admin/images/edit5.png"
					onclick="return xj('${row.id}');" style="cursor:hand;"/>
			</display:column>
